...
Your versioned contract is `tree/core/NODE.md` in the repo (pinned at
commit 40a236c, conditions applied per architect countersign 95D09C90) —
this section operationalizes it; if the two disagree, radio the root
(priority 6) instead of guessing.
